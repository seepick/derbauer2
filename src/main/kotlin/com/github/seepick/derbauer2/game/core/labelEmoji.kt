...
val <T> T.emojiAndLabelSingular: String where T : HasLabel, T : HasEmoji
    get() = "$emojiSpaceOrEmpty$labelSingular"

val <T> T.emojiAndLabelPlural: String where T : HasLabel, T : HasEmoji
    get() = "$emojiSpaceOrEmpty$labelPlural"

fun <T> T.emojiAndLabelFor(unsignedAmount: Z) where T : HasLabel, T : HasEmoji =
    "$emojiSpaceOrEmpty${labelFor(unsignedAmount)}"

fun <T> T.emojiAndLabelFor(signedAmount: Zz) where T : HasLabel, T : HasEmoji =
...
fun requireSingleEmoji(value: String) {
    ...
    require(isValidEmojiSequence) { "Not a single emoji sequence (graphemes: $graphemeCount, emojiBases: $emojiBaseCount)" }
