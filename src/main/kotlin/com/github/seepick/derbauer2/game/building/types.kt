...
class House(override var _setOwnedOnlyByTx: Z = 0.z) : Building, StoresResource {
...
class Farm(override var _setOwnedOnlyByTx: Z = 0.z) : Building, ProducesResourceOwnable {
...
class Granary(override var _setOwnedOnlyByTx: Z = 0.z) : Building, StoresResource {
