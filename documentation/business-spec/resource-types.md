...
* Simple: Gold, Food, Wood, Stone, Knowledge, ...
* Complex: Land, People, ...
...
* IDEA: maybe (???) production possible (via mines)?
...
* used for: advanced buildings, (certain) armies, ammunition, ...
* types: wood, stone, iron, ...

## Knowledge

* a.k.a. Research/Science Points
...
* enables new stuff: gets you achievements (permanent feature)
